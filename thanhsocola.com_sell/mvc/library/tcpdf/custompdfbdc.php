...
class CUSTOMPDFBDC extends TCPDF {
	...
	*/
    ...
    public function Header() {
		...
		//$this->SetX(22);
        //$this->Cell(0, 5, 'KARAOKE BA ĐỨC1', 0, false, 'L', 0, '', 0, false, 'M', 'M');
		
		//$this->SetFont('arial', '', 10);
		//$this->Ln(5);			 
		//$this->SetX(22);
        //$this->Cell(0, 5, 'Số: 67/26B Phó Cơ Điều, P.4, TP.VL', 0, false, 'L', 0, '', 0, false, 'M', 'M');
		//$this->Ln(5);	
		//$this->SetX(22);
        //$this->Cell(0, 5, 'ĐT: 0703 828 555', 0, false, 'L', 0, '', 0, false, 'M', 'M');
    }
