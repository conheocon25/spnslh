<?php
	...
	class KnowledgeNews extends Command{
		function doExecute( \MVC\Controller\Request $request ) {
			...
			$NG = $mNewsKnowledge->find($IdNews);
			$NGRelates = $mNewsKnowledge->findByCategoryDate(array($IdCategory, $NG->getDate()));
			...
			$request->setProperty("ActiveMenu", 'CategoryKnowledge');
