...
class PostRss extends Mapper implements \MVC\Domain\PostRssFinder {
    ...
    function getCollection( array $raw ) {return new PostRssCollection( $raw, $this );}
    protected function doCreateObject( array $array ) {
        $obj = new \MVC\Domain\PostRss( 
			$array['id'],
			$array['title'],
			$array['content'],
			$array['author'],
    ...
    protected function targetClass() {return "PostRss";}
