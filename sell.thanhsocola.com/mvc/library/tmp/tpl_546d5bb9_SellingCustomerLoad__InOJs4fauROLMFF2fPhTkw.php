<?php 
function tpl_546d5bb9_SellingCustomerLoad__InOJs4fauROLMFF2fPhTkw(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<a class="btn SessionInsert"><?php /* tag "i" from line 20 */; ?>
<i class="glyphicons-circle_remove"></i>thêm mới</a>
			</div>					
		</div>						
