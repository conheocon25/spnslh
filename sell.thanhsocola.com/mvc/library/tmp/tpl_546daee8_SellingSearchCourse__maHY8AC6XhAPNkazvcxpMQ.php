<?php 
function tpl_546daee8_SellingSearchCourse__maHY8AC6XhAPNkazvcxpMQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<li>	
						<?php 
/* tag "a" from line 8 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Course, 'getId')))):  ;
...
?>
<a class="course-item tip-left Course"<?php echo $_tmp_2 ?>
<?php echo $_tmp_3 ?>
>
							<?php 
/* tag "img" from line 9 */ ;
if (null !== ($_tmp_4 = ($ctx->path($ctx->Course, 'getPicture')))):  ;
$_tmp_4 = ' src="'.phptal_escape($_tmp_4).'"' ;
else:  ;
$_tmp_4 = '' ;
endif ;
?>
<img width="32"<?php echo $_tmp_4 ?>
/>
							<?php /* tag "strong" from line 10 */; ?>
<strong><?php echo phptal_escape($ctx->Course->getName() . ' ' . $ctx->Course->getPrice1Print()); ?>
</strong>
						</a>
					</li><?php 
endforeach ;
