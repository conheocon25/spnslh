<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_AdsService(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
?>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_OptionPanel(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<option value="Nunito">Nunito</option>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="fa fa-angle-up"></i></a>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_LastestPost(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_Testmonials(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_Subscribe(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<input type="submit" value="ĐĂNG KÝ" class="btn btn-custom"/>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/lien-he">Liên hệ</a>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_PageTitle(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<p><?php echo phptal_escape($ctx->path($ctx->ConfigSlogan, 'getValue')); ?>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<marquee scrolldelay="2" scrollamount="2" behavior="scroll" direction="left" style="padding:5px;">Khu Ẩm Thực Sinh Thái Làng Sen Đồng Tháp xin kính chào quý khách! Với các món ăn đa dạng và phong phú, chất lượng cao và giá phải chăng cùng phong cách phục vụ chuyên nghiệp, chu đáo, chúng tôi hứa hẹn sẽ là điểm đến tham quan, ăn uổng giải trí lý tưởng cho mọi gia đình</marquee>
					</div>
				</div>
			</div>
		</div>
...
<a href="/" title="Khu Ẩm Thực Sinh Thái Làng Sen"><?php /* tag "img" from line 80 */; ?>
...
<div id="responsive-nav-button">
										Thực đơn <?php /* tag "span" from line 107 */; ?>
...
>LIÊN HỆ</a></li>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/front/js/jquery.mlens-1.3.min.js"></script>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" href="/mvc/templates/front/css/responsive.css"/>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/icon.ico"/>
 ...
 ?>
<?php 
function tpl_5438c0c7_mFront__xCErsenKaU8qEgS1C3Nwag(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
