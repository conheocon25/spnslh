<?php 
function tpl_543976b2_FIntroduction__nfGfMm5D8NuIjCNoMg0HzQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Post, 'getURLViewFull')))):  ;
...
<span class="separator"><?php /* tag "i" from line 30 */; ?>
<i class="fa fa-eye "></i></span><?php /* tag "span" from line 30 */; ?>
...
<span class="separator"><?php /* tag "i" from line 32 */; ?>
<i class="fa fa-heart"></i></span><?php /* tag "span" from line 32 */; ?>
...
Generated by PHPTAL from G:\AppsWeb\cmsA\www.amthuclangsen.com\mvc\templates\FIntroduction.html (edit that file instead) */; ?>