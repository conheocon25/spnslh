<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_AdsService(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
?>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_OptionPanel(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<option value="Nunito">Nunito</option>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="fa fa-angle-up"></i></a>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_LastestPost(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_Testmonials(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_Subscribe(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<input type="submit" value="ĐĂNG KÝ" class="btn btn-custom"/>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<li class="active"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_Menu(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="/lien-he">Liên hệ</a>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_PageTitle(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<p><?php echo phptal_escape($ctx->path($ctx->ConfigSlogan, 'getValue')); ?>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
>LIÊN HỆ</a></li>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/front/js/jquery.mlens-1.3.min.js"></script>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="stylesheet" href="/mvc/templates/front/css/responsive.css"/>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/icon.ico"/>
 ...
 ?>
<?php 
function tpl_543cf5d7_mFront__QFFtSQlAAKfcf2fV8yq2Gg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
