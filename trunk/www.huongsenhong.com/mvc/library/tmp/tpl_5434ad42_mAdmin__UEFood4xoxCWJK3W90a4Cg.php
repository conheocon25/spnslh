<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_StyleTools(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
...
<a href="/setting/theme/red-green" alt="#red-green" style="background-image:url('/mvc/templates/theme/cms/img/demo/red-green.png');background-repeat:no-repeat;cursor:pointer;"></a>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_Footer(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a href="http://amthuclangsen.com">SPN Soft - Nhà hàng</a>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_MenuSettingProduct(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-truck"></i>DANH MỤC MÔ TẢ
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_MenuSettingPost(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-book"></i>CÂU CHUYỆN KHÁCH HÀNG
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_MenuSettingGeneral(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheel"></i>CẤU HÌNH
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_MenuSetting(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheel"></i>CẤU HÌNH
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_MenuApp(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<i class="glyphicons-cogwheels"></i>THIẾT LẬP</a>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_PageBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_ContentHeader(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
?>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_LocationBar(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<a class="current"><?php echo phptal_escape($ctx->Title); ?>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_Header(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<span class="text"><?php echo phptal_escape(\MVC\Base\SessionRegistry::instance()->getCurrentUser()->getEmail()); ?>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_IncludeJS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<script src="/mvc/templates/theme/cms/js/jquery.validate.js"></script>		
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_IncludeCSS(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
/>										
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg_IncludeMETA(PHPTAL $_thistpl, PHPTAL $tpl) {
$tpl = clone $tpl ;
$ctx = $tpl->getContext() ;
$_translator = $tpl->getTranslator() ;
?>
...
<link rel="shortcut icon" type="image/png" href="/data/images/icon.ico"/>
 ...
 ?>
<?php 
function tpl_5434ad42_mAdmin__UEFood4xoxCWJK3W90a4Cg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
$_translator = $tpl->getTranslator() ;
...
Generated by PHPTAL from G:\AppsWeb\cmsA\www.amthuclangsen.com\mvc\templates\mAdmin.xhtml (edit that file instead) */; ?>