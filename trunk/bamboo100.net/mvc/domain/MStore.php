...
class MStore extends Object{
	...
	//DEFINE URL
	//-------------------------------------------------------------------------------			
	function getURLUpdLoad(){	return "/quan-ly/quan-ly-tap-hoa/info-load";	}
	function getURLUpdExe(){	return "/quan-ly/quan-ly-tap-hoa/info-exe";		}
