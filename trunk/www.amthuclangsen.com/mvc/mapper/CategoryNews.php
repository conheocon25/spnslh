...
class CategoryNews extends Mapper implements \MVC\Domain\CategoryNewsFinder {
    ...
    function __construct() {
		...
		$findByPageStmt = sprintf("SELECT * FROM  %s LIMIT :start,:max", $tblCategoryNews);
    ...
    function getCollection( array $raw ) {return new CategoryNewsCollection( $raw, $this );}
    ...
    protected function targetClass() {  return "CategoryNews";}
