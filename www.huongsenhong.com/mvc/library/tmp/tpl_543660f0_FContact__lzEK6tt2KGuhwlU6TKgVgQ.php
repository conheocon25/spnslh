<?php 
function tpl_543660f0_FContact__lzEK6tt2KGuhwlU6TKgVgQ(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<span>Chúng tôi luôn mãi mãi lắng nghe những phản hồi của quý khách về chúng tôi. Ý kiến của quý vị sẽ làm nên sự thành công của chúng tôi.</span>
									</div>
