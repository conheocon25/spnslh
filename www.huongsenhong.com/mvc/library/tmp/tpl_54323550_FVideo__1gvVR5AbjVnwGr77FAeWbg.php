<?php 
function tpl_54323550_FVideo__1gvVR5AbjVnwGr77FAeWbg(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
$_tmp_3 = $ctx->repeat ;
$_tmp_3->Video = new PHPTAL_RepeatController($ctx->VideoAll)
 ;
$ctx = $tpl->pushContext() ;
foreach ($_tmp_3->Video as $ctx->Video): ;
?>
...
<figure>
													<?php 
/* tag "a" from line 31 */ ;
if (null !== ($_tmp_2 = ($ctx->path($ctx->Video, 'getURLView')))):  ;
...
if (null !== ($_tmp_1 = ($ctx->path($ctx->Video, 'getImage')))):  ;
...
<h3 class="item-name">
													<?php 
/* tag "a" from line 39 */ ;
if (null !== ($_tmp_1 = ($ctx->path($ctx->Video, 'getURLView')))):  ;
...
<span><?php echo phptal_escape($ctx->path($ctx->Video, 'getName')); ?>
</span>
													</a>
												</h3>
...
<p><?php echo phptal_tostring($ctx->path($ctx->Video, 'getNote')); ?>
</p>
											</div>
										</div><?php 
endforeach ;
...
Generated by PHPTAL from G:\AppsWeb\cmsA\www.amthuclangsen.com\mvc\templates\FVideo.html (edit that file instead) */; ?>