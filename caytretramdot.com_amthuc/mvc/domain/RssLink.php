...
class RssLink extends Object{
	...
	//-------------------------------------------------------------------------------
    function __construct( $Id=null, $IdCategoryPost=null,$Name=null, $Weburl=null, $Rssurl=null, $Type=null, $Enable=null, $ClassContentName=null, $ClassAuthor=null, $ImgPath=null){
		$this->Id 			= $Id;		
		$this->IdCategoryPost 	= $IdCategoryPost; 
		$this->Name 		= $Name; 
		$this->Weburl 		= $Weburl;
		$this->Rssurl		= $Rssurl;
		$this->Type 		= $Type;
    ...
    function setIdCategoryPost( $IdCategoryPost ) {$this->IdCategoryPost = $IdCategoryPost;$this->markDirty();}   
	function getIdCategoryPost( ) {return $this->IdCategoryPost;} 
	...
	function getCategoryVideo( ) {
		$mTag = new \MVC\Mapper\CategoryPost();
		$dTag = $mTag->find($this->IdCategoryPost);
		return $dTag;
	}
	...
	function toJSON(){
		$json = array(
			'Id' 			=> $this->getId(),			
			'IdCategoryPost'			=> $this->IdCategoryPost(),
			'Name'			=> $this->getName(),
